...
LEVEL_DEFINITIONS = {
    "Level 0 - Independent Prompts": {
        "range": (1, 12),
        "description": "12 fully parallel independent prompts",
    },
    "Level 1 - Single Dependencies": {
        "range": (13, 22),
        "description": "10 prompts with 1-2 dependencies",
    },
    "Level 2 - Multiple Dependencies": {
        "range": (23, 27),
        "description": "5 prompts with 2-4 dependencies",
    },
    "Level 3 - Final Prompts": {
        "range": (28, 31),
        "description": "4 final synthesis prompts",
    },
}
...
def print_report(results: dict) -> None:
    ...
    print("=" * 80)
    print("BASIC WORKBOOK VALIDATION RESULTS")
    print("=" * 80)
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate basic workbook results",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    %(prog)s ./sample_workbook.xlsx
    %(prog)s ./sample_workbook.xlsx --json
    %(prog)s ./sample_workbook.xlsx --results-sheet results_20250228_123456
        """,
    )
