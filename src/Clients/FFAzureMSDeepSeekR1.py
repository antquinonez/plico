...
# filename: src/lib/AI/FFDeepSeek.py
...
class FFAzureMSDeepSeekR1:
    def __init__(self, config: Optional[dict] = None, **kwargs):
        ...
        self.temperature = getattr(self, 'temperature', float(os.getenv('AZURE_MSDEEPSEEK_TEMPERATURE', defaults['temperature'])))
        self.max_tokens = getattr(self, 'max_tokens', int(os.getenv('AZURE_MSDEEPSEEK_MAX_TOKENS', defaults['max_tokens'])))
        self.system_instructions = getattr(self, 'system_instructions', os.getenv('AZURE_MSDEEPSEEK_SYSTEM_INSTRUCTIONS', defaults['instructions']))
