...
class ClientConfig:
    ...
    def __init__(
        self, ffai_client: FFAI, default_model: str | None = None, config: dict | None = None
    ):
    ...
    def matches_config(self, other_config: dict | None) -> bool:
        ...
        return all(
            key in self.config and self.config[key] == value
...
class FFAIClientPool:
    ...
    def add_client(
        ...
        with self._lock:
            ...
            self._clients[name] = ClientConfig(
                ffai_client=ffai_client, default_model=default_model, config=config
            )
    ...
    def get_client(
        self, name: str | None = None, config: dict | None = None
    ) -> tuple[FFAI, str | None]:
        """
